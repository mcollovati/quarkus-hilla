...
public class DropStatementMethodNode extends MethodNode {
    ...
    public DropStatementMethodNode(int api, int access, String name,
            String descriptor, String signature, String[] exceptions,
            MethodVisitor mv, Predicate<AbstractInsnNode> dropPredicate) {
    ...
    public void visitEnd() {
        ...
        while (iter.hasNext()) {
            ...
            if (instruction == null)
                break;
            iter.remove();
            // If we match against a label, then there is no previous
    ...
    private AbstractInsnNode findNextDropInstruction(
            ListIterator<AbstractInsnNode> iter) {
        while (iter.hasNext()) {
