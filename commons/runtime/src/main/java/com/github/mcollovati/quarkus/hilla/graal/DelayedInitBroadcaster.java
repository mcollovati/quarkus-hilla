...
public class DelayedInitBroadcaster extends DefaultBroadcaster {
    ...
    protected BroadcasterConfig createBroadcasterConfig(AtmosphereConfig config) {
        return new DelayedInitBroadcasterConfig(config.framework().broadcasterFilters(), config, getID()).init();
    }
    ...
    private static class DelayedInitBroadcasterConfig extends BroadcasterConfig {
        ...
        public DelayedInitBroadcasterConfig(
                List<String> broadcastFilters, AtmosphereConfig config, String broadcasterId) {
